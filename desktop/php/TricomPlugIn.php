...
$plugin = plugin::byId('TricomPlugIn');
				...
				<form class="form-horizontal">
					<fieldset>
						<div class="col-lg-6">
							...
							<div class="form-group">
								<label class="col-sm-3 control-label">{{Adresse EXO}}</label>
								<div class="col-sm-7">
									<select id="sel_exo_address" class="eqLogicAttr form-control" data-l1key="configuration" data-l2key="exoAddress" placeholder="{{Adresse EXO}}">
										<?php
										$options = '';
										for ($i = 1; $i <= 16; $i++) {
							...
							<div class="form-group">
								<label class="col-sm-3 control-label"> {{Sortie}}</label>
								<div class="col-sm-7">
									<select id="sel_output_nbr" class="eqLogicAttr form-control inputPassword" data-l1key="configuration" data-l2key="outputNbr">
										<?php
										$options = '';
										for ($i = 1; $i <= 8; $i++) {
											$options .= '<option value="' . $i . '">' . $i . '</option>';
...
<?php include_file('desktop', 'TricomPlugIn', 'js', 'TricomPlugIn');?>
